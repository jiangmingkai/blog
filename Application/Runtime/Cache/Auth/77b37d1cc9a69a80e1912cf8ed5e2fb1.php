...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        <input type="hidden" name="id" id="id" value="<?php echo ($travel["id"]); ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo ($travel["title"]); ?>" id="title" name="title"
                       required>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="url" id="url" cols="" rows="" class="textarea"
                          ...
                          required><?php echo ($travel["url"]); ?></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo ($travel["stop_time"]); ?>" id="stop_time" name="stop_time"
                       required>
            </div>
        </div>
        <div class="row cl">
