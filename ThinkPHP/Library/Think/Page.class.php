...
class Page{
    ...
    private $config  = array(
        ...
        'prev'   => '<span class="Bg"><b><</b></span>',
        'next'   => '<span class="Bg"><b>></b></span>',
        'first'  => '<<',
        'last'   => '>>',
//        'first'  => '1...',
//        'last'   => '...%TOTAL_PAGE%',
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page <= $this->totalPages){
                    $link_page .= '<a class="num"  href="' . $this->url($page) . '"><span class="Bg"><b>' . $page . '</b></span></a>';
                }else{
                    break;
                }
            }else{
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<a href="javascript:void(0)" class="current"><span class="Bg"><b>' . $page . '</b></span></a>';
                }
            }
        }
